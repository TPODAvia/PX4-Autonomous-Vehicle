# Information: https://px4_air.coex.tech/en/simple_offboard.html#navigateglobal
...
# https://px4_air.coex.tech/en/snippets.html#wait_arrival
...
if math.isnan(start.lat):
    raise Exception('No global position, install and configure GPS sensor: https://px4_air.coex.tech/gps')
